...
<body>
  ...
  <form method="GET">
    ...
    <div class="btn-group" role="group">
      ...
      <button type="submit" class="btn btn-success" formaction="division.php">Division</button>
      <button type="submit" class="btn btn-danger" formaction="producto.php">Producto</button>
    </div>
