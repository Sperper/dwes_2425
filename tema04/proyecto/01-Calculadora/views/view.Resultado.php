...
<body>
    ...
    <form>
        ...
        <div class="input-group mb-3">
            ...
            <input type="string" class="form-control" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-default" step="0.01" value="<?= $calc->getOperador() ?>" readonly>
        </div>
        ...
        <div class="input-group input-group-lg">
            ...
            <input type="number" class="form-control" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-lg" value="<?= $calc->getResultado() ?>" readonly>
        </div>
