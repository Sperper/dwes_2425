    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table">
                    ...
                    <?php while ($cliente = $clientes->fetch_object()): ?>
                        <tr class="align-middle">
                            ...
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <a href="eliminar.php?id=<?= $cliente->id ?>" title="Eliminar" class="btn btn-danger" onclick="return confirm('Confimar elimación del alumno')"><i class="bi bi-trash-fill"></i></a>
                ...
                <tfoot>
                    <tr><td colspan="6">Nº Alumnos <?= $clientes->num_rows ?></td></tr>
                </tfoot>
            </table>
        </div>
    </div>
