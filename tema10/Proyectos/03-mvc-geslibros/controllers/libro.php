    ...
    */
    public function pdf($param = [])
    {
        ...
        foreach ($libros as $libro) {
            ...
            $pdf->Cell(50, 8, mb_convert_encoding($libro['titulo'], 'ISO-8859-1', 'UTF-8'), 1, 0, 'L', $fondo);
            $pdf->Cell(50, 8, mb_convert_encoding($libro['autor'], 'ISO-8859-1', 'UTF-8'), 1, 0, 'L', $fondo);
            $pdf->Cell(50, 8, mb_convert_encoding($libro['editorial'], 'ISO-8859-1', 'UTF-8'), 1, 0, 'L', $fondo);
            $pdf->Cell(14, 8, mb_convert_encoding($libro['stock'], 'ISO-8859-1', 'UTF-8'), 1, 0, 'R', $fondo);
            $pdf->Cell(14, 8, mb_convert_encoding($libro['precio'], 'ISO-8859-1', 'UTF-8'), 1, 1, 'R', $fondo);
