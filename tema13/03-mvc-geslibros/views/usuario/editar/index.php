        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= URL ?>usuario/update/<?= htmlspecialchars($this->usuario->id) ?>" method="POST">
                    ...
                    <!-- id oculto -->
                    <input type="number" class="form-control" name="id" value="<?= htmlspecialchars($this->usuario->id) ?>" hidden>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input id="password" type="password"
                                class="form-control <?= (isset($this->error['password'])) ? 'is-invalid' : null ?>"
